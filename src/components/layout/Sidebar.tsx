...
const navItems = [
  ...
  { href: '/dashboard/email-report', label: 'Email Report', icon: BarChart3,  adminOnly: false },
  { href: '/dashboard/delivery-failures', label: 'Delivery Failures', icon: Mail, adminOnly: false },
