...
-- CURATED REACHAGENT V2 GOLDEN BASELINE
-- Derived in a disposable PostgreSQL 17.6/Supabase-compatible catalog from the
-- verified schema-only evidence, then explicitly reduced and hardened to the
-- approved Section 17 contract. This is not a mechanical production dump and
-- contains neither V1 migration replay nor customer/operational data.
...
-- ReachAgent-owned SECURITY DEFINER routines use a dedicated no-login owner.
DO $do$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_catalog.pg_roles WHERE rolname='reachagent_function_owner') THEN
    CREATE ROLE reachagent_function_owner NOLOGIN NOINHERIT BYPASSRLS;
  END IF;
END
$do$;

-- Hosted Supabase's project postgres role cannot transfer ownership to the
-- managed supabase_admin role. Temporarily allow this migration session to
-- assign ReachAgent-owned objects to the dedicated NOLOGIN owner; membership
-- is revoked at the end of the migration.
GRANT reachagent_function_owner TO CURRENT_USER WITH INHERIT TRUE, SET TRUE;

--
-- Name: extensions; Type: SCHEMA; Schema: -; Owner: platform-managed
--
...
-- A role must have CREATE on the containing schema before it can receive
-- function ownership. This grant exists only while ownership is assigned.
...
--
-- Name: reachagent_private; Type: SCHEMA; Schema: -; Owner: reachagent_function_owner
--

CREATE SCHEMA IF NOT EXISTS reachagent_private;

ALTER SCHEMA reachagent_private OWNER TO reachagent_function_owner;

--
-- Name: claim_hostinger_inbound_receipt(uuid, text, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.claim_hostinger_inbound_receipt(p_receipt_id uuid, p_run_id text, p_stale_before timestamp with time zone) RETURNS TABLE(receipt_id uuid, attempt_count integer)
...
ALTER FUNCTION public.claim_hostinger_inbound_receipt(p_receipt_id uuid, p_run_id text, p_stale_before timestamp with time zone) OWNER TO reachagent_function_owner;

--
-- Name: claim_recipient_outreach(uuid, text); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.claim_recipient_outreach(p_lead_id uuid, p_phase text) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
ALTER FUNCTION public.claim_recipient_outreach(p_lead_id uuid, p_phase text) OWNER TO reachagent_function_owner;

--
-- Name: classify_data_quality_group(jsonb); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.classify_data_quality_group(p_leads jsonb) RETURNS jsonb
...
--
-- Name: classify_email_quality(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.classify_email_quality(p_email text) RETURNS TABLE(issue_type text, reason text)
...
--
-- Name: clear_lead_outreach_suppression_on_email_change(); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.clear_lead_outreach_suppression_on_email_change() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
DECLARE v_bad text;
...
--
-- Name: data_quality_compact_identity(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.data_quality_compact_identity(p_value text) RETURNS text
    LANGUAGE sql IMMUTABLE PARALLEL SAFE
    AS $$
...
--
-- Name: data_quality_meaningful_website_identity(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.data_quality_meaningful_website_identity(p_value text) RETURNS text
    LANGUAGE sql IMMUTABLE PARALLEL SAFE
    AS $$
...
--
-- Name: data_quality_phone_identity(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.data_quality_phone_identity(p_value text) RETURNS text
    LANGUAGE sql IMMUTABLE PARALLEL SAFE
    AS $$
...
--
-- Name: data_quality_present(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.data_quality_present(p_value text) RETURNS text
    LANGUAGE sql IMMUTABLE PARALLEL SAFE
    AS $$
  SELECT CASE
...
--
-- Name: data_quality_social_identity(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.data_quality_social_identity(p_value text) RETURNS text
...
--
-- Name: data_quality_website_identity(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.data_quality_website_identity(p_value text) RETURNS text
    LANGUAGE plpgsql IMMUTABLE PARALLEL SAFE
    AS $_$
DECLARE v_value TEXT := lower(public.data_quality_present(p_value));
BEGIN
...
--
-- Name: get_ai_request_analytics(timestamp with time zone, timestamp with time zone, text, text, text, integer); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.get_ai_request_analytics(p_start_at timestamp with time zone DEFAULT NULL::timestamp with time zone, p_end_at timestamp with time zone DEFAULT NULL::timestamp with time zone, p_workflow text DEFAULT NULL::text, p_provider text DEFAULT NULL::text, p_status text DEFAULT NULL::text, p_recent_limit integer DEFAULT 50) RETURNS jsonb
...
ALTER FUNCTION public.get_ai_request_analytics(p_start_at timestamp with time zone, p_end_at timestamp with time zone, p_workflow text, p_provider text, p_status text, p_recent_limit integer) OWNER TO reachagent_function_owner;

--
-- Name: get_dashboard_summary(timestamp with time zone); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_dashboard_summary(p_as_of timestamp with time zone DEFAULT now()) RETURNS jsonb
    LANGUAGE sql STABLE
...
--
-- Name: get_data_quality_report(text, text, text, text, text, integer, integer); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.get_data_quality_report(p_issue_type text DEFAULT NULL::text, p_email text DEFAULT NULL::text, p_business text DEFAULT NULL::text, p_category text DEFAULT NULL::text, p_city text DEFAULT NULL::text, p_page integer DEFAULT 1, p_page_size integer DEFAULT 50) RETURNS jsonb
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
ALTER FUNCTION public.get_data_quality_report(p_issue_type text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer) OWNER TO reachagent_function_owner;

--
-- Name: get_data_quality_report_v2(text, text, text, text, text, text, integer, integer); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.get_data_quality_report_v2(p_issue_type text DEFAULT NULL::text, p_search text DEFAULT NULL::text, p_email text DEFAULT NULL::text, p_business text DEFAULT NULL::text, p_category text DEFAULT NULL::text, p_city text DEFAULT NULL::text, p_page integer DEFAULT 1, p_page_size integer DEFAULT 50) RETURNS jsonb
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
ALTER FUNCTION public.get_data_quality_report_v2(p_issue_type text, p_search text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer) OWNER TO reachagent_function_owner;

--
-- Name: get_data_quality_summary(); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.get_data_quality_summary() RETURNS jsonb
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
--
-- Name: get_deals_search_page(text, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_deals_search_page(p_search text DEFAULT ''::text, p_page integer DEFAULT 1, p_page_size integer DEFAULT 50) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
WITH validated AS (
...
--
-- Name: get_delivery_failure_lead_selection(text, text, text, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_delivery_failure_lead_selection(p_status text DEFAULT NULL::text, p_email_type text DEFAULT NULL::text, p_search text DEFAULT ''::text, p_include_ids boolean DEFAULT false) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
WITH
...
--
-- Name: get_delivery_failure_report(text, text, text, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_delivery_failure_report(p_status text DEFAULT NULL::text, p_email_type text DEFAULT NULL::text, p_search text DEFAULT ''::text, p_page integer DEFAULT 1, p_page_size integer DEFAULT 50) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
WITH
...
--
-- Name: get_dm_queue_search_page(text, text, text, text, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_dm_queue_search_page(p_status text DEFAULT NULL::text, p_platform text DEFAULT NULL::text, p_city text DEFAULT NULL::text, p_search text DEFAULT ''::text, p_page integer DEFAULT 1, p_page_size integer DEFAULT 50) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
WITH validated AS (
...
--
-- Name: get_email_log_search_page(text, text, text, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_email_log_search_page(p_type text DEFAULT NULL::text, p_status text DEFAULT NULL::text, p_search text DEFAULT ''::text, p_page integer DEFAULT 1, p_page_size integer DEFAULT 50) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
WITH validated AS (
...
--
-- Name: get_email_log_summary(text, text, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_email_log_summary(p_type text DEFAULT NULL::text, p_status text DEFAULT NULL::text, p_search text DEFAULT ''::text) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
WITH validated AS (
...
--
-- Name: get_email_report_leads(text[], text[]); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_email_report_leads(p_addresses text[], p_domains text[]) RETURNS TABLE(id uuid, business_name text, email text, status text)
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
...
--
-- Name: get_health_summary(timestamp with time zone); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_health_summary(p_as_of timestamp with time zone DEFAULT now()) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
...
--
-- Name: get_lead_status_counts(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_lead_status_counts() RETURNS TABLE(status text, count bigint)
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
...
--
-- Name: get_leads_search_page(text[], text, text, text, integer, integer, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_leads_search_page(p_statuses text[] DEFAULT NULL::text[], p_category text DEFAULT NULL::text, p_city text DEFAULT NULL::text, p_search text DEFAULT ''::text, p_page integer DEFAULT 1, p_page_size integer DEFAULT 50, p_ids_only boolean DEFAULT false) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
WITH validated AS (
...
--
-- Name: get_lifecycle_page(timestamp with time zone, text, text, text, text, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_lifecycle_page(p_as_of timestamp with time zone DEFAULT now(), p_filter text DEFAULT 'all'::text, p_search text DEFAULT ''::text, p_sort_key text DEFAULT 'next_action_date'::text, p_sort_dir text DEFAULT 'asc'::text, p_page integer DEFAULT 1, p_page_size integer DEFAULT 50) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
WITH
...
--
-- Name: get_pipeline_search_page(text[], text, integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_pipeline_search_page(p_statuses text[], p_search text DEFAULT ''::text, p_page integer DEFAULT 1, p_page_size integer DEFAULT 50) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog'
    AS $$
WITH validated AS (
...
--
-- Name: handle_new_auth_user(); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--
...
--
-- Name: is_active_admin(); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--
...
--
-- Name: literal_ilike_pattern(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.literal_ilike_pattern(p_search text) RETURNS text
    LANGUAGE sql IMMUTABLE PARALLEL SAFE
    SET search_path TO 'pg_catalog'
    AS $$
...
--
-- Name: normalize_lead_fields(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.normalize_lead_fields() RETURNS trigger
    LANGUAGE plpgsql
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
--
-- Name: refresh_email_group_quality(text); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.refresh_email_group_quality(p_email text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
ALTER FUNCTION public.refresh_email_group_quality(p_email text) OWNER TO reachagent_function_owner;

--
-- Name: refresh_lead_data_quality(uuid); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.refresh_lead_data_quality(p_lead_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
ALTER FUNCTION public.refresh_lead_data_quality(p_lead_id uuid) OWNER TO reachagent_function_owner;

--
-- Name: release_recipient_outreach_claim(uuid, text, uuid); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.release_recipient_outreach_claim(p_lead_id uuid, p_normalized_email text, p_claim_token uuid) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
ALTER FUNCTION public.release_recipient_outreach_claim(p_lead_id uuid, p_normalized_email text, p_claim_token uuid) OWNER TO reachagent_function_owner;

--
-- Name: remove_data_quality_emails(uuid[]); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.remove_data_quality_emails(p_lead_ids uuid[]) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
DECLARE
...
ALTER FUNCTION public.remove_data_quality_emails(p_lead_ids uuid[]) OWNER TO reachagent_function_owner;

--
-- Name: set_data_quality_flag_status(text, text, uuid[], text, text); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.set_data_quality_flag_status(p_issue_type text, p_normalized_email text DEFAULT NULL::text, p_lead_ids uuid[] DEFAULT NULL::uuid[], p_status text DEFAULT 'resolved'::text, p_resolution_reason text DEFAULT NULL::text) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
DECLARE
...
ALTER FUNCTION public.set_data_quality_flag_status(p_issue_type text, p_normalized_email text, p_lead_ids uuid[], p_status text, p_resolution_reason text) OWNER TO reachagent_function_owner;

--
-- Name: suppress_lead_delivery_email(uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.suppress_lead_delivery_email(p_lead_id uuid, p_email text) RETURNS void
    LANGUAGE sql
    SET search_path TO ''
    AS $$
  UPDATE public.leads
...
--
-- Name: trigger_refresh_lead_data_quality(); Type: FUNCTION; Schema: public; Owner: reachagent_function_owner
--

CREATE FUNCTION public.trigger_refresh_lead_data_quality() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public'
    AS $$
BEGIN
...
--
-- Name: claim_hostinger_inbound_receipt(uuid, text, timestamp with time zone); Type: FUNCTION; Schema: reachagent_private; Owner: reachagent_function_owner
--

CREATE FUNCTION reachagent_private.claim_hostinger_inbound_receipt(p_receipt_id uuid, p_run_id text, p_stale_before timestamp with time zone) RETURNS TABLE(receipt_id uuid, attempt_count integer)
    LANGUAGE sql
    SET search_path TO 'pg_catalog', 'public'
    AS $$
...
ALTER FUNCTION reachagent_private.claim_hostinger_inbound_receipt(p_receipt_id uuid, p_run_id text, p_stale_before timestamp with time zone) OWNER TO reachagent_function_owner;

--
-- Name: claim_recipient_outreach(uuid, text); Type: FUNCTION; Schema: reachagent_private; Owner: reachagent_function_owner
--

CREATE FUNCTION reachagent_private.claim_recipient_outreach(p_lead_id uuid, p_phase text) RETURNS jsonb
    LANGUAGE plpgsql
    SET search_path TO 'pg_catalog', 'public'
    AS $$
DECLARE
...
ALTER FUNCTION reachagent_private.claim_recipient_outreach(p_lead_id uuid, p_phase text) OWNER TO reachagent_function_owner;

--
-- Name: get_ai_request_analytics(timestamp with time zone, timestamp with time zone, text, text, text, integer); Type: FUNCTION; Schema: reachagent_private; Owner: reachagent_function_owner
--

CREATE FUNCTION reachagent_private.get_ai_request_analytics(p_start_at timestamp with time zone DEFAULT NULL::timestamp with time zone, p_end_at timestamp with time zone DEFAULT NULL::timestamp with time zone, p_workflow text DEFAULT NULL::text, p_provider text DEFAULT NULL::text, p_status text DEFAULT NULL::text, p_recent_limit integer DEFAULT 50) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog', 'public'
    AS $$
  WITH filtered AS MATERIALIZED (
    ...
    WHERE (COALESCE(NULLIF(pg_catalog.current_setting('request.jwt.claim.role', true), ''), (NULLIF(pg_catalog.current_setting('request.jwt.claims', true), '')::jsonb ->> 'role'))::text = 'service_role' OR public.is_active_admin())
...
ALTER FUNCTION reachagent_private.get_ai_request_analytics(p_start_at timestamp with time zone, p_end_at timestamp with time zone, p_workflow text, p_provider text, p_status text, p_recent_limit integer) OWNER TO reachagent_function_owner;

--
-- Name: get_data_quality_report(text, text, text, text, text, integer, integer); Type: FUNCTION; Schema: reachagent_private; Owner: reachagent_function_owner
--

CREATE FUNCTION reachagent_private.get_data_quality_report(p_issue_type text DEFAULT NULL::text, p_email text DEFAULT NULL::text, p_business text DEFAULT NULL::text, p_category text DEFAULT NULL::text, p_city text DEFAULT NULL::text, p_page integer DEFAULT 1, p_page_size integer DEFAULT 50) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog', 'public'
    AS $_$
WITH lead_facts AS (
  ...
  SELECT normalized_email, COUNT(*)::INT lead_count,
    ...
    bool_or(has_deal OR status IN ('closed')) has_deal,
    ...
    (array_agg(id ORDER BY
      (email_has_reply OR has_deal OR status IN ('replied','negotiating','interested','closed')) DESC,
      CASE status WHEN 'closed' THEN 65 WHEN 'negotiating' THEN 60 WHEN 'interested' THEN 55 WHEN 'replied' THEN 50 WHEN 'contacted' THEN 30 WHEN 'email_ready' THEN 20 WHEN 'researched' THEN 10 ELSE 0 END DESC,
      outreach_count DESC,
  ...
  SELECT f.normalized_email, f.issue_type, 1::INT lead_count, ARRAY[l.id] lead_ids, ARRAY[l.business_name] business_names,
    ...
    l.has_deal OR l.status IN ('closed') has_deal,
...
ALTER FUNCTION reachagent_private.get_data_quality_report(p_issue_type text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer) OWNER TO reachagent_function_owner;

--
-- Name: get_data_quality_report_v2(text, text, text, text, text, text, integer, integer); Type: FUNCTION; Schema: reachagent_private; Owner: reachagent_function_owner
--

CREATE FUNCTION reachagent_private.get_data_quality_report_v2(p_issue_type text DEFAULT NULL::text, p_search text DEFAULT NULL::text, p_email text DEFAULT NULL::text, p_business text DEFAULT NULL::text, p_category text DEFAULT NULL::text, p_city text DEFAULT NULL::text, p_page integer DEFAULT 1, p_page_size integer DEFAULT 50) RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog', 'public'
    AS $$
WITH lead_facts AS (
  ...
  SELECT normalized_email,COUNT(*)::INT lead_count,array_agg(id ORDER BY created_at) lead_ids,
    ...
    SUM(outreach_count)::INT outreach_count,MAX(latest_outreach_at) latest_outreach_at,
    bool_or(email_has_reply OR status IN ('replied','negotiating','interested')) has_reply,
    bool_or(has_deal OR status IN ('closed','closed_manual')) has_deal,
    bool_or(NULLIF(btrim(notes),'') IS NOT NULL) has_notes,bool_or(all_email_count>0) has_email_history,
    (array_agg(id ORDER BY
      (email_has_reply OR has_deal OR status IN ('replied','negotiating','interested','closed','closed_manual')) DESC,
      CASE status WHEN 'closed' THEN 65 WHEN 'closed_manual' THEN 65 WHEN 'negotiating' THEN 60
  ...
  SELECT f.normalized_email,f.issue_type,1::INT lead_count,ARRAY[l.id] lead_ids,ARRAY[l.business_name] business_names,
    ...
    (l.status IN ('replied','negotiating','interested') OR l.email_has_reply) has_reply,
    (l.has_deal OR l.status IN ('closed','closed_manual')) has_deal,
...
ALTER FUNCTION reachagent_private.get_data_quality_report_v2(p_issue_type text, p_search text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer) OWNER TO reachagent_function_owner;

--
-- Name: get_data_quality_summary(); Type: FUNCTION; Schema: reachagent_private; Owner: reachagent_function_owner
--

CREATE FUNCTION reachagent_private.get_data_quality_summary() RETURNS jsonb
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog', 'public'
    AS $$
WITH open_flags AS (
  ...
  WHERE l.status IN ('replied','negotiating','interested','closed','closed_manual')
...
--
-- Name: is_active_admin(); Type: FUNCTION; Schema: reachagent_private; Owner: reachagent_function_owner
--

CREATE FUNCTION reachagent_private.is_active_admin() RETURNS boolean
    LANGUAGE sql STABLE
    SET search_path TO 'pg_catalog', 'public'
    AS $$
  SELECT EXISTS (
    ...
    WHERE id = COALESCE(NULLIF(pg_catalog.current_setting('request.jwt.claim.sub', true), ''), (NULLIF(pg_catalog.current_setting('request.jwt.claims', true), '')::jsonb ->> 'sub'))::uuid
      AND role = 'admin'
      AND is_active = true
  );
$$;
...
--
-- Name: refresh_email_group_quality(text); Type: FUNCTION; Schema: reachagent_private; Owner: reachagent_function_owner
--

CREATE FUNCTION reachagent_private.refresh_email_group_quality(p_email text) RETURNS void
    LANGUAGE plpgsql
    SET search_path TO 'pg_catalog', 'public'
    AS $$
...
ALTER FUNCTION reachagent_private.refresh_email_group_quality(p_email text) OWNER TO reachagent_function_owner;

--
-- Name: refresh_lead_data_quality(uuid); Type: FUNCTION; Schema: reachagent_private; Owner: reachagent_function_owner
--

CREATE FUNCTION reachagent_private.refresh_lead_data_quality(p_lead_id uuid) RETURNS void
    LANGUAGE plpgsql
...
ALTER FUNCTION reachagent_private.refresh_lead_data_quality(p_lead_id uuid) OWNER TO reachagent_function_owner;

--
-- Name: release_recipient_outreach_claim(uuid, text, uuid); Type: FUNCTION; Schema: reachagent_private; Owner: reachagent_function_owner
--

CREATE FUNCTION reachagent_private.release_recipient_outreach_claim(p_lead_id uuid, p_normalized_email text, p_claim_token uuid) RETURNS boolean
    LANGUAGE plpgsql
    SET search_path TO 'pg_catalog', 'public'
    AS $$
DECLARE
...
ALTER FUNCTION reachagent_private.release_recipient_outreach_claim(p_lead_id uuid, p_normalized_email text, p_claim_token uuid) OWNER TO reachagent_function_owner;
...
--
-- Name: ai_workflow_configurations; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ai_workflow_configurations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: category_email_templates; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_priorities; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_search_state; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: city_suburbs; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.city_suburbs (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    city text NOT NULL,
    ...
    CONSTRAINT city_suburbs_priority_check CHECK (((priority >= 1) AND (priority <= 10)))
);
...
--
-- Name: discovery_run_metrics; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.discovery_run_metrics (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: distributed_locks; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: dm_queue; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: exhausted_queries; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.exhausted_queries (
    query text NOT NULL,
    city text NOT NULL,
...
--
-- Name: inbound_receipts; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: lead_data_quality_flags; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.leads (
    ...
    CONSTRAINT leads_status_check CHECK ((status = ANY (ARRAY['new'::text, 'researched'::text, 'email_ready'::text, 'contacted'::text, 'replied'::text, 'interested'::text, 'negotiating'::text, 'closed'::text, 'closed_manual'::text, 'dead'::text])))
);
...
--
-- Name: COLUMN leads.category_id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.leads.category_id IS 'Authoritative category identity. Nullable only for staged legacy import; a later validated V2 migration sets NOT NULL after exact/approved-alias remediation reaches zero ambiguous/unmatched rows.';


--
-- Name: COLUMN leads.source; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: COLUMN leads.delivery_suppressed_emails; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: recipient_outreach_ownership; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: ai_models ai_models_provider_model_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ai_providers ai_providers_provider_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ai_workflow_configurations ai_workflow_configurations_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ai_workflow_configurations ai_workflow_configurations_workflow_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_email_templates category_email_templates_category_type_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_email_templates category_email_templates_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_priorities category_suburb_priorities_category_suburb_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_priorities category_suburb_priorities_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_search_state category_suburb_search_state_category_suburb_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_search_state category_suburb_search_state_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: city_suburbs city_suburbs_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: discovery_run_metrics discovery_run_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: distributed_locks distributed_locks_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: dm_queue dm_queue_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: emails emails_resend_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: exhausted_queries exhausted_queries_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: inbound_receipts inbound_receipts_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: inbound_receipts inbound_receipts_receipt_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: lead_data_quality_flags lead_data_quality_flags_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: recipient_outreach_ownership recipient_outreach_ownership_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: activity_log_delivery_email_created_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: activity_log_event_type_created_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: activity_log_inbound_receipt_event_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: activity_log_lead_id_created_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ai_models_provider_enabled_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ai_request_logs_created_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ai_request_logs_provider_created_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ai_request_logs_status_created_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: ai_request_logs_workflow_created_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: categories_name_trimmed_lower_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: category_email_templates_type_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_priorities_city_suburb_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_search_state_city_suburb_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: discovery_run_metrics_run_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: dm_queue_handle_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX dm_queue_handle_trgm_idx ON public.dm_queue USING gin (handle extensions.gin_trgm_ops);


--
-- Name: emails_created_at_id_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: emails_lead_id_created_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: emails_lead_type_delivered_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: emails_message_id_not_null_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: emails_one_pending_initial_per_lead_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: emails_replied_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: emails_status_created_at_id_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: emails_status_sent_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: emails_subject_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX emails_subject_trgm_idx ON public.emails USING gin (subject extensions.gin_trgm_ops);


--
-- Name: emails_type_created_at_id_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: inbound_receipts_status_updated_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: lead_data_quality_flags_email_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: lead_data_quality_flags_open_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: lead_data_quality_flags_status_updated_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: leads_business_name_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: leads_city_status_created_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: leads_email_report_address_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: leads_email_report_domain_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: leads_email_trgm_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX leads_email_trgm_idx ON public.leads USING gin (email extensions.gin_trgm_ops) WHERE (email IS NOT NULL);


--
-- Name: leads_normalized_email_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: leads_status_created_at_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: recipient_outreach_owner_lead_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: search_cache_query_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: auth.users on_auth_user_created; Type: TRIGGER; Schema: auth
--
...
--
-- Name: leads leads_clear_outreach_suppression_on_email_change; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER leads_clear_outreach_suppression_on_email_change AFTER UPDATE OF email ON public.leads FOR EACH ROW EXECUTE FUNCTION public.clear_lead_outreach_suppression_on_email_change();


--
-- Name: leads leads_normalize_fields; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER leads_normalize_fields BEFORE INSERT OR UPDATE OF business_name, email, normalized_email ON public.leads FOR EACH ROW EXECUTE FUNCTION public.normalize_lead_fields();


--
-- Name: leads leads_refresh_data_quality; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER leads_refresh_data_quality AFTER INSERT OR UPDATE OF email, business_name, website, phone, address, suburb, instagram_handle ON public.leads FOR EACH ROW EXECUTE FUNCTION public.trigger_refresh_lead_data_quality();


--
-- Name: ai_models update_ai_models_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
--
-- Name: ai_workflow_configurations update_ai_workflow_configurations_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_ai_workflow_configurations_updated_at BEFORE UPDATE ON public.ai_workflow_configurations FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: category_email_templates update_category_email_templates_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_category_email_templates_updated_at BEFORE UPDATE ON public.category_email_templates FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: category_suburb_priorities update_category_suburb_priorities_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_category_suburb_priorities_updated_at BEFORE UPDATE ON public.category_suburb_priorities FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: category_suburb_search_state update_category_suburb_search_state_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER update_category_suburb_search_state_updated_at BEFORE UPDATE ON public.category_suburb_search_state FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
--
-- Name: activity_log activity_log_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ai_workflow_configurations ai_workflow_configurations_model_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_email_templates category_email_templates_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_priorities category_suburb_priorities_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_priorities category_suburb_priorities_city_suburb_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_search_state category_suburb_search_state_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: category_suburb_search_state category_suburb_search_state_city_suburb_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: dm_queue dm_queue_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: follow_ups follow_ups_email_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: lead_data_quality_flags lead_data_quality_flags_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: lead_data_quality_flags lead_data_quality_flags_resolved_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: recipient_outreach_ownership recipient_outreach_ownership_owner_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: activity_log activity_member_append; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY activity_member_append ON public.activity_log FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: activity_log activity_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY activity_member_read ON public.activity_log FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: ai_models; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.ai_models ENABLE ROW LEVEL SECURITY;

--
-- Name: ai_models ai_models_admin_manage; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY ai_models_admin_manage ON public.ai_models TO authenticated USING (public.is_active_admin()) WITH CHECK (public.is_active_admin());


--
-- Name: ai_models ai_models_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY ai_models_member_read ON public.ai_models FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));
...
--
-- Name: ai_providers ai_providers_admin_manage; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY ai_providers_admin_manage ON public.ai_providers TO authenticated USING (public.is_active_admin()) WITH CHECK (public.is_active_admin());


--
-- Name: ai_providers ai_providers_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY ai_providers_member_read ON public.ai_providers FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));
...
--
-- Name: ai_request_logs ai_request_logs_admin_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY ai_request_logs_admin_read ON public.ai_request_logs FOR SELECT TO authenticated USING (public.is_active_admin());


--
-- Name: ai_workflow_configurations; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.ai_workflow_configurations ENABLE ROW LEVEL SECURITY;

--
-- Name: ai_workflow_configurations ai_workflow_configurations_admin_manage; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY ai_workflow_configurations_admin_manage ON public.ai_workflow_configurations TO authenticated USING (public.is_active_admin()) WITH CHECK (public.is_active_admin());


--
-- Name: ai_workflow_configurations ai_workflow_configurations_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY ai_workflow_configurations_member_read ON public.ai_workflow_configurations FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));
...
--
-- Name: categories categories_admin_manage; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY categories_admin_manage ON public.categories TO authenticated USING (public.is_active_admin()) WITH CHECK (public.is_active_admin());


--
-- Name: categories categories_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY categories_member_read ON public.categories FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: category_email_templates; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.category_email_templates ENABLE ROW LEVEL SECURITY;

--
-- Name: category_email_templates category_email_templates_admin_manage; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY category_email_templates_admin_manage ON public.category_email_templates TO authenticated USING (public.is_active_admin()) WITH CHECK (public.is_active_admin());


--
-- Name: category_email_templates category_email_templates_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY category_email_templates_member_read ON public.category_email_templates FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: category_suburb_priorities; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.category_suburb_priorities ENABLE ROW LEVEL SECURITY;

--
-- Name: category_suburb_priorities category_suburb_priorities_admin_manage; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY category_suburb_priorities_admin_manage ON public.category_suburb_priorities TO authenticated USING (public.is_active_admin()) WITH CHECK (public.is_active_admin());


--
-- Name: category_suburb_priorities category_suburb_priorities_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY category_suburb_priorities_member_read ON public.category_suburb_priorities FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: category_suburb_search_state; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.category_suburb_search_state ENABLE ROW LEVEL SECURITY;

--
-- Name: category_suburb_search_state category_suburb_search_state_admin_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY category_suburb_search_state_admin_read ON public.category_suburb_search_state FOR SELECT TO authenticated USING (public.is_active_admin());


--
-- Name: city_suburbs; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.city_suburbs ENABLE ROW LEVEL SECURITY;

--
-- Name: city_suburbs city_suburbs_admin_manage; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY city_suburbs_admin_manage ON public.city_suburbs TO authenticated USING (public.is_active_admin()) WITH CHECK (public.is_active_admin());


--
-- Name: city_suburbs city_suburbs_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY city_suburbs_member_read ON public.city_suburbs FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: dead_letter_queue; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.dead_letter_queue ENABLE ROW LEVEL SECURITY;

--
-- Name: dead_letter_queue dead_letter_queue_admin_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY dead_letter_queue_admin_read ON public.dead_letter_queue FOR SELECT TO authenticated USING (public.is_active_admin());
...
--
-- Name: deals deals_admin_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY deals_admin_delete ON public.deals FOR DELETE TO authenticated USING (public.is_active_admin());


--
-- Name: deals deals_member_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY deals_member_insert ON public.deals FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: deals deals_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY deals_member_read ON public.deals FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: deals deals_member_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY deals_member_update ON public.deals FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active)))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: discovery_run_metrics; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.discovery_run_metrics ENABLE ROW LEVEL SECURITY;

--
-- Name: discovery_run_metrics discovery_run_metrics_admin_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY discovery_run_metrics_admin_read ON public.discovery_run_metrics FOR SELECT TO authenticated USING (public.is_active_admin());


--
-- Name: distributed_locks; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.distributed_locks ENABLE ROW LEVEL SECURITY;

--
-- Name: dm_queue; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.dm_queue ENABLE ROW LEVEL SECURITY;

--
-- Name: dm_queue dm_queue_admin_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY dm_queue_admin_delete ON public.dm_queue FOR DELETE TO authenticated USING (public.is_active_admin());


--
-- Name: dm_queue dm_queue_member_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY dm_queue_member_insert ON public.dm_queue FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: dm_queue dm_queue_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY dm_queue_member_read ON public.dm_queue FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: dm_queue dm_queue_member_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY dm_queue_member_update ON public.dm_queue FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active)))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));
...
--
-- Name: emails emails_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY emails_member_read ON public.emails FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: exhausted_queries; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.exhausted_queries ENABLE ROW LEVEL SECURITY;

--
-- Name: exhausted_queries exhausted_queries_admin_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY exhausted_queries_admin_read ON public.exhausted_queries FOR SELECT TO authenticated USING (public.is_active_admin());
...
--
-- Name: follow_ups follow_ups_admin_delete; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY follow_ups_admin_delete ON public.follow_ups FOR DELETE TO authenticated USING (public.is_active_admin());


--
-- Name: follow_ups follow_ups_member_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY follow_ups_member_insert ON public.follow_ups FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: follow_ups follow_ups_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY follow_ups_member_read ON public.follow_ups FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: follow_ups follow_ups_member_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY follow_ups_member_update ON public.follow_ups FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active)))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));
...
--
-- Name: inbound_receipts; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.inbound_receipts ENABLE ROW LEVEL SECURITY;

--
-- Name: inbound_receipts inbound_receipts_admin_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY inbound_receipts_admin_read ON public.inbound_receipts FOR SELECT TO authenticated USING (public.is_active_admin());


--
-- Name: lead_data_quality_flags; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: leads leads_admin_delete; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: leads leads_member_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY leads_member_insert ON public.leads FOR INSERT TO authenticated WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: leads leads_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY leads_member_read ON public.leads FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: leads leads_member_update; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY leads_member_update ON public.leads FOR UPDATE TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active)))) WITH CHECK ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));
...
--
-- Name: recipient_outreach_ownership ownership_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY ownership_member_read ON public.recipient_outreach_ownership FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));
...
--
-- Name: profiles profiles_admin_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY profiles_admin_read ON public.profiles FOR SELECT TO authenticated USING (public.is_active_admin());
...
--
-- Name: profiles profiles_update_own_display; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY profiles_update_own_display ON public.profiles FOR UPDATE TO authenticated USING (((id = auth.uid()) AND is_active)) WITH CHECK (((id = auth.uid()) AND is_active));


--
-- Name: lead_data_quality_flags quality_member_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY quality_member_read ON public.lead_data_quality_flags FOR SELECT TO authenticated USING ((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))));


--
-- Name: recipient_outreach_ownership; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: search_cache search_cache_admin_read; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY search_cache_admin_read ON public.search_cache FOR SELECT TO authenticated USING (public.is_active_admin());
...
--
-- Name: settings settings_admin_manage; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY settings_admin_manage ON public.settings TO authenticated USING (public.is_active_admin()) WITH CHECK (public.is_active_admin());


--
-- Name: settings settings_member_read_allowlist; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY settings_member_read_allowlist ON public.settings FOR SELECT TO authenticated USING (((EXISTS ( SELECT 1
   FROM public.profiles p
  WHERE ((p.id = auth.uid()) AND p.is_active))) AND (key = ANY (ARRAY['active_cities'::text, 'system_active'::text, 'daily_lead_limit'::text, 'daily_initial_outreach_limit'::text, 'daily_dm_limit'::text, 'daily_outscraper_limit'::text, 'daily_followup1_limit'::text, 'daily_followup2_limit'::text, 'daily_followup3_limit'::text, 'daily_reactivation_limit'::text, 'follow_up_1_days'::text, 'follow_up_2_days'::text, 'follow_up_3_days'::text, 'dead_lead_days'::text, 'reactivation_enabled'::text, 'reactivation_delay_days'::text, 'dead_after_reactivation_days'::text, 'enable_lead_filtering'::text, 'blocked_business_keywords'::text, 'primary_search_api'::text, 'initial_email_mode'::text]))));
...
GRANT USAGE ON SCHEMA public TO reachagent_function_owner;
GRANT USAGE ON SCHEMA public TO authenticated;


--
-- Name: SCHEMA reachagent_private; Type: ACL; Schema: -; Owner: reachagent_function_owner
--

REVOKE ALL ON SCHEMA reachagent_private FROM PUBLIC;
GRANT USAGE ON SCHEMA reachagent_private TO reachagent_function_owner;


-- Hosted Supabase injects broad direct grants for new public objects. Clear
-- those platform defaults before rebuilding the explicit ReachAgent allowlist.
...
REVOKE ALL ON ALL FUNCTIONS IN SCHEMA reachagent_private FROM PUBLIC, anon, authenticated, service_role;


--
-- Name: FUNCTION claim_hostinger_inbound_receipt(p_receipt_id uuid, p_run_id text, p_stale_before timestamp with time zone); Type: ACL; Schema: public; Owner: reachagent_function_owner
--
...
--
-- Name: FUNCTION claim_recipient_outreach(p_lead_id uuid, p_phase text); Type: ACL; Schema: public; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION public.claim_recipient_outreach(p_lead_id uuid, p_phase text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.claim_recipient_outreach(p_lead_id uuid, p_phase text) TO service_role;


--
-- Name: FUNCTION classify_data_quality_group(p_leads jsonb); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.classify_data_quality_group(p_leads jsonb) FROM PUBLIC;
GRANT ALL ON FUNCTION public.classify_data_quality_group(p_leads jsonb) TO reachagent_function_owner;


--
-- Name: FUNCTION classify_email_quality(p_email text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.classify_email_quality(p_email text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.classify_email_quality(p_email text) TO reachagent_function_owner;


--
-- Name: FUNCTION clear_lead_outreach_suppression_on_email_change(); Type: ACL; Schema: public; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION public.clear_lead_outreach_suppression_on_email_change() FROM PUBLIC;


--
-- Name: FUNCTION data_quality_compact_identity(p_value text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.data_quality_compact_identity(p_value text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.data_quality_compact_identity(p_value text) TO reachagent_function_owner;


--
-- Name: FUNCTION data_quality_meaningful_website_identity(p_value text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.data_quality_meaningful_website_identity(p_value text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.data_quality_meaningful_website_identity(p_value text) TO reachagent_function_owner;


--
-- Name: FUNCTION data_quality_phone_identity(p_value text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.data_quality_phone_identity(p_value text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.data_quality_phone_identity(p_value text) TO reachagent_function_owner;


--
-- Name: FUNCTION data_quality_present(p_value text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.data_quality_present(p_value text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.data_quality_present(p_value text) TO reachagent_function_owner;


--
-- Name: FUNCTION data_quality_social_identity(p_value text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.data_quality_social_identity(p_value text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.data_quality_social_identity(p_value text) TO reachagent_function_owner;


--
-- Name: FUNCTION data_quality_website_identity(p_value text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.data_quality_website_identity(p_value text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.data_quality_website_identity(p_value text) TO reachagent_function_owner;


--
-- Name: FUNCTION get_ai_request_analytics(p_start_at timestamp with time zone, p_end_at timestamp with time zone, p_workflow text, p_provider text, p_status text, p_recent_limit integer); Type: ACL; Schema: public; Owner: reachagent_function_owner
--
...
--
-- Name: FUNCTION get_dashboard_summary(p_as_of timestamp with time zone); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.get_dashboard_summary(p_as_of timestamp with time zone) FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_dashboard_summary(p_as_of timestamp with time zone) TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_data_quality_report(p_issue_type text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer); Type: ACL; Schema: public; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION public.get_data_quality_report(p_issue_type text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer) FROM PUBLIC;
...
--
-- Name: FUNCTION get_data_quality_report_v2(p_issue_type text, p_search text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer); Type: ACL; Schema: public; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION public.get_data_quality_report_v2(p_issue_type text, p_search text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer) FROM PUBLIC;
...
--
-- Name: FUNCTION get_data_quality_summary(); Type: ACL; Schema: public; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION public.get_data_quality_summary() FROM PUBLIC;
...
--
-- Name: FUNCTION get_deals_search_page(p_search text, p_page integer, p_page_size integer); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.get_deals_search_page(p_search text, p_page integer, p_page_size integer) FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_deals_search_page(p_search text, p_page integer, p_page_size integer) TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_delivery_failure_lead_selection(p_status text, p_email_type text, p_search text, p_include_ids boolean); Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON FUNCTION public.get_delivery_failure_lead_selection(p_status text, p_email_type text, p_search text, p_include_ids boolean) TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_delivery_failure_report(p_status text, p_email_type text, p_search text, p_page integer, p_page_size integer); Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON FUNCTION public.get_delivery_failure_report(p_status text, p_email_type text, p_search text, p_page integer, p_page_size integer) TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_dm_queue_search_page(p_status text, p_platform text, p_city text, p_search text, p_page integer, p_page_size integer); Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON FUNCTION public.get_dm_queue_search_page(p_status text, p_platform text, p_city text, p_search text, p_page integer, p_page_size integer) TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_email_log_search_page(p_type text, p_status text, p_search text, p_page integer, p_page_size integer); Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON FUNCTION public.get_email_log_search_page(p_type text, p_status text, p_search text, p_page integer, p_page_size integer) TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_email_log_summary(p_type text, p_status text, p_search text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.get_email_log_summary(p_type text, p_status text, p_search text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_email_log_summary(p_type text, p_status text, p_search text) TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_email_report_leads(p_addresses text[], p_domains text[]); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.get_email_report_leads(p_addresses text[], p_domains text[]) FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_email_report_leads(p_addresses text[], p_domains text[]) TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_health_summary(p_as_of timestamp with time zone); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.get_health_summary(p_as_of timestamp with time zone) FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_health_summary(p_as_of timestamp with time zone) TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_lead_status_counts(); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.get_lead_status_counts() FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_lead_status_counts() TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_leads_search_page(p_statuses text[], p_category text, p_city text, p_search text, p_page integer, p_page_size integer, p_ids_only boolean); Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON FUNCTION public.get_leads_search_page(p_statuses text[], p_category text, p_city text, p_search text, p_page integer, p_page_size integer, p_ids_only boolean) TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_lifecycle_page(p_as_of timestamp with time zone, p_filter text, p_search text, p_sort_key text, p_sort_dir text, p_page integer, p_page_size integer); Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON FUNCTION public.get_lifecycle_page(p_as_of timestamp with time zone, p_filter text, p_search text, p_sort_key text, p_sort_dir text, p_page integer, p_page_size integer) TO reachagent_function_owner;
...
--
-- Name: FUNCTION get_pipeline_search_page(p_statuses text[], p_search text, p_page integer, p_page_size integer); Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON FUNCTION public.get_pipeline_search_page(p_statuses text[], p_search text, p_page integer, p_page_size integer) TO reachagent_function_owner;
...
--
-- Name: FUNCTION handle_new_auth_user(); Type: ACL; Schema: public; Owner: reachagent_function_owner
--
...
--
-- Name: FUNCTION is_active_admin(); Type: ACL; Schema: public; Owner: reachagent_function_owner
--
...
--
-- Name: FUNCTION literal_ilike_pattern(p_search text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.literal_ilike_pattern(p_search text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.literal_ilike_pattern(p_search text) TO reachagent_function_owner;


--
-- Name: FUNCTION normalize_lead_fields(); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.normalize_lead_fields() FROM PUBLIC;
GRANT ALL ON FUNCTION public.normalize_lead_fields() TO reachagent_function_owner;


--
-- Name: FUNCTION refresh_email_group_quality(p_email text); Type: ACL; Schema: public; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION public.refresh_email_group_quality(p_email text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.refresh_email_group_quality(p_email text) TO service_role;


--
-- Name: FUNCTION refresh_lead_data_quality(p_lead_id uuid); Type: ACL; Schema: public; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION public.refresh_lead_data_quality(p_lead_id uuid) FROM PUBLIC;
GRANT ALL ON FUNCTION public.refresh_lead_data_quality(p_lead_id uuid) TO service_role;


--
-- Name: FUNCTION release_recipient_outreach_claim(p_lead_id uuid, p_normalized_email text, p_claim_token uuid); Type: ACL; Schema: public; Owner: reachagent_function_owner
--
...
--
-- Name: FUNCTION remove_data_quality_emails(p_lead_ids uuid[]); Type: ACL; Schema: public; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION public.remove_data_quality_emails(p_lead_ids uuid[]) FROM PUBLIC;
GRANT ALL ON FUNCTION public.remove_data_quality_emails(p_lead_ids uuid[]) TO authenticated;
GRANT ALL ON FUNCTION public.remove_data_quality_emails(p_lead_ids uuid[]) TO service_role;


--
-- Name: FUNCTION set_data_quality_flag_status(p_issue_type text, p_normalized_email text, p_lead_ids uuid[], p_status text, p_resolution_reason text); Type: ACL; Schema: public; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION public.set_data_quality_flag_status(p_issue_type text, p_normalized_email text, p_lead_ids uuid[], p_status text, p_resolution_reason text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.set_data_quality_flag_status(p_issue_type text, p_normalized_email text, p_lead_ids uuid[], p_status text, p_resolution_reason text) TO authenticated;
GRANT ALL ON FUNCTION public.set_data_quality_flag_status(p_issue_type text, p_normalized_email text, p_lead_ids uuid[], p_status text, p_resolution_reason text) TO service_role;


--
-- Name: FUNCTION suppress_lead_delivery_email(p_lead_id uuid, p_email text); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.suppress_lead_delivery_email(p_lead_id uuid, p_email text) FROM PUBLIC;
GRANT ALL ON FUNCTION public.suppress_lead_delivery_email(p_lead_id uuid, p_email text) TO reachagent_function_owner;
GRANT ALL ON FUNCTION public.suppress_lead_delivery_email(p_lead_id uuid, p_email text) TO service_role;


--
-- Name: FUNCTION trigger_refresh_lead_data_quality(); Type: ACL; Schema: public; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION public.trigger_refresh_lead_data_quality() FROM PUBLIC;
...
GRANT ALL ON FUNCTION public.update_updated_at_column() TO reachagent_function_owner;


--
-- Name: FUNCTION claim_hostinger_inbound_receipt(p_receipt_id uuid, p_run_id text, p_stale_before timestamp with time zone); Type: ACL; Schema: reachagent_private; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION reachagent_private.claim_hostinger_inbound_receipt(p_receipt_id uuid, p_run_id text, p_stale_before timestamp with time zone) FROM PUBLIC;


--
-- Name: FUNCTION claim_recipient_outreach(p_lead_id uuid, p_phase text); Type: ACL; Schema: reachagent_private; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION reachagent_private.claim_recipient_outreach(p_lead_id uuid, p_phase text) FROM PUBLIC;


--
-- Name: FUNCTION get_ai_request_analytics(p_start_at timestamp with time zone, p_end_at timestamp with time zone, p_workflow text, p_provider text, p_status text, p_recent_limit integer); Type: ACL; Schema: reachagent_private; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION reachagent_private.get_ai_request_analytics(p_start_at timestamp with time zone, p_end_at timestamp with time zone, p_workflow text, p_provider text, p_status text, p_recent_limit integer) FROM PUBLIC;


--
-- Name: FUNCTION get_data_quality_report(p_issue_type text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer); Type: ACL; Schema: reachagent_private; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION reachagent_private.get_data_quality_report(p_issue_type text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer) FROM PUBLIC;


--
-- Name: FUNCTION get_data_quality_report_v2(p_issue_type text, p_search text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer); Type: ACL; Schema: reachagent_private; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION reachagent_private.get_data_quality_report_v2(p_issue_type text, p_search text, p_email text, p_business text, p_category text, p_city text, p_page integer, p_page_size integer) FROM PUBLIC;


--
-- Name: FUNCTION get_data_quality_summary(); Type: ACL; Schema: reachagent_private; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION reachagent_private.get_data_quality_summary() FROM PUBLIC;


--
-- Name: FUNCTION is_active_admin(); Type: ACL; Schema: reachagent_private; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION reachagent_private.is_active_admin() FROM PUBLIC;


--
-- Name: FUNCTION refresh_email_group_quality(p_email text); Type: ACL; Schema: reachagent_private; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION reachagent_private.refresh_email_group_quality(p_email text) FROM PUBLIC;


--
-- Name: FUNCTION refresh_lead_data_quality(p_lead_id uuid); Type: ACL; Schema: reachagent_private; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION reachagent_private.refresh_lead_data_quality(p_lead_id uuid) FROM PUBLIC;


--
-- Name: FUNCTION release_recipient_outreach_claim(p_lead_id uuid, p_normalized_email text, p_claim_token uuid); Type: ACL; Schema: reachagent_private; Owner: reachagent_function_owner
--

REVOKE ALL ON FUNCTION reachagent_private.release_recipient_outreach_claim(p_lead_id uuid, p_normalized_email text, p_claim_token uuid) FROM PUBLIC;
...
GRANT ALL ON TABLE public.activity_log TO reachagent_function_owner;
...
GRANT ALL ON TABLE public.ai_models TO reachagent_function_owner;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.ai_models TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.ai_models TO service_role;
...
GRANT ALL ON TABLE public.ai_providers TO reachagent_function_owner;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.ai_providers TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.ai_providers TO service_role;
...
GRANT ALL ON TABLE public.ai_request_logs TO reachagent_function_owner;
GRANT SELECT ON TABLE public.ai_request_logs TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.ai_request_logs TO service_role;


--
-- Name: TABLE ai_workflow_configurations; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.ai_workflow_configurations TO reachagent_function_owner;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.ai_workflow_configurations TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.ai_workflow_configurations TO service_role;
...
GRANT ALL ON TABLE public.categories TO reachagent_function_owner;
...
--
-- Name: TABLE category_email_templates; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.category_email_templates TO reachagent_function_owner;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.category_email_templates TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.category_email_templates TO service_role;


--
-- Name: TABLE category_suburb_priorities; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.category_suburb_priorities TO reachagent_function_owner;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.category_suburb_priorities TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.category_suburb_priorities TO service_role;


--
-- Name: TABLE category_suburb_search_state; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.category_suburb_search_state TO reachagent_function_owner;
GRANT SELECT ON TABLE public.category_suburb_search_state TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.category_suburb_search_state TO service_role;


--
-- Name: TABLE city_suburbs; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.city_suburbs TO reachagent_function_owner;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.city_suburbs TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.city_suburbs TO service_role;


--
-- Name: TABLE dead_letter_queue; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.dead_letter_queue TO reachagent_function_owner;
GRANT SELECT ON TABLE public.dead_letter_queue TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.dead_letter_queue TO service_role;
...
GRANT ALL ON TABLE public.deals TO reachagent_function_owner;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.deals TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.deals TO service_role;


--
-- Name: TABLE discovery_run_metrics; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.discovery_run_metrics TO reachagent_function_owner;
GRANT SELECT ON TABLE public.discovery_run_metrics TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.discovery_run_metrics TO service_role;


--
-- Name: TABLE distributed_locks; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.distributed_locks TO reachagent_function_owner;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.distributed_locks TO service_role;


--
-- Name: TABLE dm_queue; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.dm_queue TO reachagent_function_owner;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.dm_queue TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.dm_queue TO service_role;
...
GRANT ALL ON TABLE public.emails TO reachagent_function_owner;
GRANT SELECT ON TABLE public.emails TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.emails TO service_role;


--
-- Name: TABLE exhausted_queries; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.exhausted_queries TO reachagent_function_owner;
GRANT SELECT ON TABLE public.exhausted_queries TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.exhausted_queries TO service_role;
...
GRANT ALL ON TABLE public.follow_ups TO reachagent_function_owner;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.follow_ups TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.follow_ups TO service_role;


--
-- Name: TABLE inbound_receipts; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.inbound_receipts TO reachagent_function_owner;
GRANT SELECT ON TABLE public.inbound_receipts TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.inbound_receipts TO service_role;


--
-- Name: TABLE lead_data_quality_flags; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.lead_data_quality_flags TO reachagent_function_owner;
GRANT SELECT ON TABLE public.lead_data_quality_flags TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.lead_data_quality_flags TO service_role;
...
GRANT ALL ON TABLE public.leads TO reachagent_function_owner;
...
GRANT ALL ON TABLE public.profiles TO reachagent_function_owner;
...
--
-- Name: TABLE recipient_outreach_ownership; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.recipient_outreach_ownership TO reachagent_function_owner;
GRANT SELECT ON TABLE public.recipient_outreach_ownership TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.recipient_outreach_ownership TO service_role;
...
GRANT ALL ON TABLE public.search_cache TO reachagent_function_owner;
GRANT SELECT ON TABLE public.search_cache TO authenticated;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.search_cache TO service_role;
...
GRANT ALL ON TABLE public.settings TO reachagent_function_owner;
...
-- The deployment login must not retain membership in the privileged NOLOGIN
-- function owner after all ownership transfers are complete. PostgreSQL 17
-- may retain a separate platform-issued ADMIN-only creator grant; it has
-- neither INHERIT nor SET and is not changed here.
